...
# Advancements Setting
    $tellraw @s [{text: "Reset Advancements: [", color: dark_gray}, {text: $(advancement), color: $(advancementcolor), bold: true, click_event: {action: "run_command", command: "/function deathswap:config/$(advancementfunction)"}, hover_event: {action: "show_text", value: "If all advancements should be removed before a round starts"}}, {text: "]", color: dark_gray, bold: false}]

# Grace Period Setting
    $tellraw @s [{text: "Grace Period: [", color: dark_gray}, {text: $(grace), color: $(gracecolor), bold: true, click_event: {action: "run_command", command: "/function deathswap:config/$(gracefunction)"}, hover_event: {action: "show_text", value: "When enabled, first timer will take twice as long as maximum time between swaps"}}, {text: "]", color: dark_gray, bold: false}]

# Timer Setting
    $tellraw @s [{text: "Timer View: [", color: dark_gray},{text: $(timer), color: $(timercolor), bold: true, click_event: {action: "run_command", command: "/function deathswap:config/$(timerfunction)"}, hover_event: {action: "show_text", value: "How players see how much time is left until the next swap (vague gives < values"}},{text: "]", color: dark_gray, bold: false}]
